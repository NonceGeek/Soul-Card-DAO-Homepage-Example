...
function UnApprovedNfts({ nft, blockExplorer, readContracts, writeContracts, tx }) {
          ...
          title={
            <div>
              <Address value={curNft.owner} blockExplorer={blockExplorer} />
                <p>token Id: {curNft.tokenId}</p>
            </div>
          }
          description={
            loading ? "loading" : <iframe src={curNft.tokenURI} width="600px" height="400px"></iframe>
          }
        />
      </Item>
    </div>
